...
if uploaded_file is not None:
    ...
    d2 = st.number_input("Введите диаметр рабочего колеса (D2) в мм", min_value=0, step=1, value=120)
    d2_new = st.number_input("Введите диаметр обточки рабочего колеса (D2') в мм", min_value=0, step=1, value=110)
